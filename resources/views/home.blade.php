...
$heroBag = $bags['kora-duffel-cacao'];
$faqs = [
...
<head>
    ...
    <meta name="description" content="{{ $brand }} - Maison ivoirienne de sacs Kora Duffel.">
    ...
    <style>
        ...
        * {
        ...
        .page-shell {
            ...
            overflow: hidden;
            background:
                radial-gradient(circle at 75% 10%, rgba(198, 167, 94, .22), transparent 30%),
                radial-gradient(circle at 20% 30%, rgba(255, 255, 255, .09), transparent 40%),
        ...
        .bg-layer {
            ...
            opacity: .12;
            filter: saturate(0.8) contrast(0.8) blur(2px);
        ...
        .bg-overlay {
            position: absolute;
            inset: 0;
            background: linear-gradient(180deg, rgba(5, 5, 5, 0.15) 0%, rgba(10, 10, 10, 0.05) 50%, rgba(5, 5, 5, 0.10) 100%);
            pointer-events: none;
        }
        ...
        .bg-soft-light {
            ...
            inset: 0;
            background:
                radial-gradient(circle at 50% 0%, rgba(255, 245, 200, .30), transparent 50%),
                radial-gradient(circle at 15% 65%, rgba(198, 167, 94, .20), transparent 50%);
        ...
        .brand-mark {
            width: 36px;
            height: 36px;
            border: 1px solid rgba(198, 167, 94, .58);
            border-radius: 8px;
            display: grid;
            place-items: center;
        ...
        .product-card:hover {
            border-color: rgba(198, 167, 94, .38);
        ...
        /* Image produit: taille contrôlée et adaptée */
        ...
        .stage:hover .product-visual img {
        ...
        /* Texte visible et lisible sur fond sombre */
        .muted {
            color: #ffffff;
            text-shadow: 0 2px 10px rgba(0, 0, 0, 0.8);
        }

        /* Amélioration lisibilité des textes - tous les textes */
        .readable-text {
...
<body>
    <div class="page-shell">
        @php
        $bgByPage = [
        'home' => 'images/sacs/logo statuette dorée.jpeg',
        'collection' => 'images/sacs/images pour banniere ou background.jpeg',
        'product' => 'images/sacs/image pour banniere ou background.jpeg',
        'faq' => 'images/sacs/image pour background faq.jpg',
        'contact' => 'images/sacs/image pour background faq.jpg',
        ...
        <main>
            ...
            <section class="container hero">
                <div class="glass-backplate">
                    <span class="eyebrow">Kora Duffel</span>
                    <h1>Le style Blac-Joyaux, en détail.</h1>
                    <p class="lead">Découvrez la forme iconique Kora Duffel : corps rectangulaire, anses doubles, zip doré, poche latérale et breloque signature. Cliquez sur un modèle pour voir ses caractéristiques.</p>
                ...
                <div class="stage" aria-label="Statuette dorée">
                    <span class="stage-label">Statuette dorée</span>
                    <div class="product-visual large" style="background: transparent; border: 0; box-shadow: none;">
                        <img src="{{ asset('images/sacs/logo statuette dorée.jpeg') }}" alt="Statuette dorée" loading="eager" />
                    </div>
                </div>
            </section>
            ...
            <section class="container section">
                <div class="section-head">
                    <div>
                        ...
                        <h2>Les sacs disponibles</h2>
                    </div>
                    <a class="button secondary" href="{{ route('collection') }}">Tout voir</a>
                </div>
                <div class="grid three">
                    @php $homeBags = array_slice($bags, 0, 3); @endphp
                    @foreach ($homeBags as $bag)
                    <article class="card product-card">
                        ...
                        <div class="button-row"><a class="button secondary" href="{{ route('sacs.show', $bag['slug']) }}">Voir details</a></div>
                    </article>
                    @endforeach
                </div>
            </section>
            ...
            <section class="container section">
                <div class="section-head">
                    <div>
                        ...
                        <h1>Choisissez votre Kora Duffel.</h1>
                        <p>Chaque carte mène vers une page produit avec caractéristiques et bouton d'ajout au panier.</p>
                    </div>
                </div>
                ...
                <div class="grid three">
                    ...
                    <article class="card product-card">
                        ...
                        <div class="button-row">
                            <a class="button secondary" href="{{ route('sacs.show', $bag['slug']) }}">Caracteristiques</a>
            ...
            <section class="container section split">
                ...
                <div class="stage" aria-label="Vue produit {{ $product['name'] }}">
                    ...
                    <div class="button-row" style="margin-top:16px;">
                        <button class="button secondary" type="button" id="frame-prev" aria-label="Image précédente">←</button>
                        <button class="button secondary" type="button" id="frame-next" aria-label="Image suivante">→</button>
                    </div>
                    <p class="muted" style="margin-top:10px;font-size:13px;">Faites glisser ou utilisez les flèches pour changer la vue.</p>
                    @endif
                </div>

                <div>
                    <span class="eyebrow">Fiche produit</span>
                    <h1>{{ $product['name'] }}</h1>
                    ...
                    <div class="specs">
                        ...
                        <div class="spec"><span>Matiere</span>{{ $product['material'] }}</div>
                        <div class="spec"><span>Origine</span>Concu et assemble en Côte d'Ivoire</div>
                    </div>
                    ...
                    <form class="button-row" action="{{ route('cart.add', $product['slug']) }}" method="post">
                        @csrf
                        <input class="field" style="max-width: 110px;" type="number" name="quantity" value="1" min="1" max="9" aria-label="Quantite">
            ...
            <section class="container section">
                <div class="section-head">
                    <div>
                        <span class="eyebrow">Vues studio</span>
                        <h2>Face, profil et ouverture</h2>
                    </div>
                </div>
                <div class="studio-grid">
                    <div class="studio-panel" data-label="Front view">
                        <div class="product-visual">
                            <img src="{{ asset($product['image']) }}" alt="{{ $product['name'] }}" loading="lazy" />
                        </div>
                    </div>
                    <div class="grid">
                        <div class="studio-panel" data-label="Side profile">
                            <div class="product-visual small">
                                <img src="{{ asset($product['image']) }}" alt="{{ $product['name'] }}" loading="lazy" />
                            </div>
                        </div>
                        <div class="studio-panel" data-label="Top open view">
                            <div class="product-visual small">
                                <img src="{{ asset($product['image']) }}" alt="{{ $product['name'] }}" loading="lazy" />
                            </div>
                        </div>
            ...
            <section class="container section">
                <div class="section-head">
                    <div>
                        ...
                        <h1>Votre panier Blac-Joyaux</h1>
                        <p>Consultez les sacs ajoutés avant de confirmer votre commande.</p>
                    </div>
                </div>
                ...
                <div class="card">
                    ...
                    <p>Choisissez un modèle Kora Duffel dans la collection pour l'ajouter ici.</p>
                    <a class="button" href="{{ route('collection') }}">Voir la collection</a>
                </div>
                @else
                <div class="grid">
                    ...
                    <article class="card cart-row">
                        <a href="{{ route('sacs.show', $item['bag']['slug']) }}">
                            <div class="product-visual small" style="width: 130px; min-height: 110px; margin: 0;">
                                <img src="{{ asset($item['bag']['image']) }}" alt="{{ $item['bag']['name'] }}" loading="lazy" />
                            </div>
                        </a>
                        <div>
                            <h3>{{ $item['bag']['name'] }}</h3>
                            <p>Quantite: {{ $item['quantity'] }} · {{ $item['bag']['price_label'] }} / piece</p>
                            <p class="price">Sous-total: {{ number_format($item['bag']['price'] * $item['quantity'], 0, ',', ' ') }} FCFA</p>
                        </div>
                        <form action="{{ route('cart.remove', $item['bag']['slug']) }}" method="post">
                            @csrf
                ...
                <div class="card cart-total">
                    <h3>Total</h3>
                    <p class="price" style="font-size:24px;">{{ number_format($cartTotal, 0, ',', ' ') }} FCFA</p>
                </div>
            ...
            <section class="container section split">
                ...
                <div class="grid">
                    <article class="card">
                        ...
                        <p class="readable-text">Cuirs, textiles et doublures sont sélectionnés pour leur résistance, leur toucher et leur rendu visuel.</p>
                    </article>
                    <article class="card">
                        <h3>Finitions nettes</h3>
                        <p class="readable-text">Les coutures, bords, fermoirs, tirettes et détails dorés sont vérifiés pour offrir une finition propre et durable.</p>
                    </article>
                    <article class="card">
                        <h3>Usage réel</h3>
                        <p class="readable-text">Le Kora Duffel garde un format pratique: ordinateur fin, carnet, portefeuille, lunettes et essentiels de journée.</p>
                    </article>
                </div>
            </section>
            ...
            <section class="container section split">
                <div>
                    ...
                    <h1>Blac-Joyaux, une maison ivoirienne dédiée aux sacs.</h1>
                    <p class="lead readable-text">La marque propose des sacs élégants, identifiables et accessibles à une clientèle qui aime les pièces fortes sans excès.</p>
                </div>
                <div class="stage" style="min-height:350px;">
                    <span class="stage-label">Notre histoire</span>
                    <div style="padding:30px;text-align:center;">
                        <h3 style="color:var(--gold);margin-bottom:16px;">Blac-Joyaux</h3>
                        <p class="readable-text" style="max-width:400px;">Née en Côte d'Ivoire, Blac-Joyaux incarne l'élégance africaine contemporaine à travers des sacs iconiques, imaginés et assemblés avec passion.</p>
                    </div>
                </div>
            </section>
            ...
            <section class="container section split">
                <div>
                    ...
                    <p class="lead">Notre équipe vous répond du lundi au samedi, de 9h00 à 18h00. Livraison disponible en Côte d'Ivoire et à l'international.</p>

                    @if ($cartCount > 0)
                    <div class="card">
                        <h3>Panier actuel</h3>
                        <p>{{ $cartCount }} article(s), total {{ number_format($cartTotal, 0, ',', ' ') }} FCFA.</p>
                        <a class="button secondary" href="{{ route('panier') }}">Consulter le panier</a>
                    </div>
                    @endif
                    ...
                    <div class="grid two">
                        <article class="card">
                            <h3>WhatsApp</h3>
                            <p><a href="https://wa.me/2250700000000">+225 07 00 00 00 00</a></p>
                        </article>
                        <article class="card">
                            <h3>E-mail</h3>
                            <p><a href="mailto:contact@blac-joyaux.com">contact@blac-joyaux.com</a></p>
                        </article>
                    </div>
                </div>

                @if ($page === 'commande')
                <form class="card" method="post" action="{{ route('commande.complete') }}">
                    @csrf
                    <h3>Finaliser</h3>
                    <p style="margin-top:8px;">En validant, votre commande est confirmée et vous revenez automatiquement sur la collection.</p>
                ...
                <form class="card form" action="{{ route('contact') }}" method="get">
                    ...
                    <input class="field" name="modele" placeholder="Modele souhaite">
            ...
            <section class="container section">
                ...
                <h1>Vos sacs favoris.</h1>
                <p class="lead">Ajoutez bientôt vos modèles préférés ici. Pour le moment, parcourez la collection et ouvrez les fiches produit.</p>
                <div class="button-row"><a class="button" href="{{ route('collection') }}">Retour à la collection</a><a class="button secondary" href="{{ route('panier') }}">Voir le panier</a></div>
            </section>
            @else
            <section class="container section">
                <span class="eyebrow">{{ $pages[$page]['title'] }}</span>
                <h1>{{ $pages[$page]['title'] }} {{ $brand }}</h1>
                <p class="lead">Informations administratives de la maison {{ $brand }}. Pour toute question, contactez-nous directement.</p>
        ...
        <footer class="site-footer">
            <div class="container footer-inner">
                <span>© {{ date('Y') }} <span class="footer-brand">{{ $brand }}</span>. Sacs conçus en Côte d'Ivoire.</span>
                <div class="footer-links">
                    <a href="{{ route('mentions-legales') }}">Mentions legales</a>
                    <a href="{{ route('confidentialite') }}">Confidentialite</a>
                    <a href="{{ route('faq') }}">FAQ</a>
                    <a href="{{ route('panier') }}">Panier @if ($cartCount > 0)({{ $cartCount }})@endif</a>
                </div>
            </div>
            <div class="container" style="text-align:center;padding-top:12px;border-top:1px solid rgba(255,255,255,.06);margin-top:12px;font-size:12px;opacity:.6;">
                Site réalisé par <strong style="color:#c6a75e;">Novacom</strong>
            </div>
        </footer>
    </div>
    ...
    <div class="modal-overlay" id="checkout-modal">
        <div class="modal-box">
            ...
            <div style="margin:12px 0;padding:12px;border:1px solid rgba(255,255,255,.08);border-radius:8px;">
                ...
                <div style="display:flex;justify-content:space-between;font-size:18px;font-weight:700;color:var(--gold);margin-top:8px;">
                    <span>Total:</span>
            ...
            <div class="modal-actions">
                ...
                <form method="post" action="{{ route('commande.complete') }}" style="flex:1;">
                    @csrf
                    <button class="button" type="submit" style="width:100%;">Confirmer la commande</button>
                </form>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        (function() {
            ...
            const onScroll = () => {
                ...
                raf = requestAnimationFrame(() => {
                    ...
                    bg.style.transform = `translate3d(0, ${y * 0.07}px, 0)`;
                });
            };
        ...
        (function() {
            ...
            let frames = [];
            try {
                frames = JSON.parse(img.getAttribute('data-frames') || '[]');
            } catch (e) {
                frames = [];
            }
